...
ch4_flux_1 = requests.get(
    ...
    f"{RASTER_API_URL}/collections/{items[tarih[1]+"-01"]['collection']}/items/{items[tarih[1]+"-01"]['id']}/tilejson.json?"
...
ch4_flux_2 = requests.get(
    ...
    # Pass the collection name, the item number in the list, and its ID
    f"{RASTER_API_URL}/collections/{items[tarih[2]+"-01"]['collection']}/items/{items[tarih[2]+"-01"]['id']}/tilejson.json?"
...
<body>
    ...
    <iframe src="3.html" title="Harita"></iframe>
</body>
</html>
"""
